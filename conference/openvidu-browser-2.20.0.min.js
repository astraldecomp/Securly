(function () {
...
})()(
  {
    ...
    2: [
      ...
      { "./stun.json": 3, "./turn.json": 4, normalice: 8 },
    ],
    3: [
      function (require, module, exports) {
        module.exports = [
      ...
      function (require, module, exports) {
        module.exports = {
          ...
          scripts: {
            ...
            build:
              "cd src/OpenVidu && ./../../node_modules/typescript/bin/tsc && cd ../.. && ./node_modules/typescript/bin/tsc --declaration src/index.ts --outDir ./lib --sourceMap --target es5 --lib dom,es5,es2015.promise,scripthost",
              ...
              try {
                ...
                if (typeof MediaRecorder.isTypeSupported === "function") {
                  if (!!mimeType) {
                    ...
                    logger.log(
                      "No mimeType parameter provided. Using default codecs"
                    );
                  }
                } else {
                  logger.warn(
        ...
        var OpenVidu = (function () {
          ...
          OpenVidu.prototype.sendNewVideoDimensionsIfRequired = function (
            ...
            var repeatUntilChangeOrMaxAttempts = setInterval(function () {
              ...
              publisher
                .getVideoDimensions(publisher.stream.getMediaStream())
                .then(function (newDimensions) {
                  if (
          ...
          OpenVidu.prototype.getUserMedia = function (options) {
            var _this = this;
            return new Promise(function (resolve, reject) {
              var askForAudioStreamOnly = function (
                previousMediaStream,
                constraints
              ) {
                ...
                navigator.mediaDevices
                  ...
                  .catch(function (error) {
                    ...
                    reject(
                      _this.generateAudioDeviceError(error, constraintsAux)
                    );
                  });
              };
              _this
                ...
                .then(function (myConstraints) {
                  ...
                  if (
                    ...
                    resolve(
                      _this.addAlreadyProvidedTracks(
                        myConstraints,
                        new MediaStream()
                      )
                    );
                          ...
                          _this.sendRequest(
                            ...
                            function (error, response) {
                              if (_this.life === response.life) {
                                ...
                                logger.warn(
                                  "Websocket was able to reconnect to OpenVidu Server, but your Master Node crashed."
                                );
        ...
        var Publisher = (function (_super) {
          ...
          Publisher.prototype.replaceTrack = function (track) {
            return __awaiter(this, void 0, void 0, function () {
              var replaceTrackInMediaStream,
                replaceTrackInRtcRtpSender,
                trackOriginalEnabledValue,
                error_1;
              var _this = this;
                    ...
                    replaceTrackInMediaStream = function () {
                      return new Promise(function (resolve, reject) {
                        ...
                        if (
                          ...
                          _this.openvidu.sendNewVideoDimensionsIfRequired(
                            _this,
                            "trackReplaced",
                            50,
                            30
            ...
            return new Promise(function (resolve, reject) {
              ...
              var successCallback = function (mediaStream) {
                ...
                if (_this.stream.isSendVideo()) {
                  _this
                    .getVideoDimensions(mediaStream)
                ...
                if (_this.stream.isSendScreen() && _this.stream.isSendAudio()) {
                  ...
                  navigator.mediaDevices
                    ...
                    .catch(function (error) {
                      ...
                      errorCallback(
                        _this.openvidu.generateAudioDeviceError(
                          error,
                          constraints
                        )
                      );
              ...
              var getMediaError = function (error) {
                ...
                switch (error.name.toLowerCase()) {
                  case "notfounderror":
                    navigator.mediaDevices
                      .getUserMedia({ audio: false, video: constraints.video })
                      .then(function (mediaStream) {
                        mediaStream.getVideoTracks().forEach(function (track) {
                          track.stop();
                        });
        ...
        var Session = (function (_super) {
          ...
          Session.prototype.onFilterEventDispatched = function (event) {
            ...
            this.getConnection(
              ...
              var stream = connection.stream;
              (_a = stream.filter.handlers.get(event.eventType)) === null ||
              _a === void 0
                ? void 0
                : _a.call(
                    _this,
                  ...
                  _this.openvidu.sendRequest(
                    ...
                    function (error, response) {
                      if (!!error) {
                        ...
                        existingParticipants.forEach(function (
          ...
          Session.prototype.processJoinRoomResponse = function (opts) {
            ...
            if (
              opts.coturnIp != null &&
              opts.turnUsername != null &&
              opts.turnCredential != null
            ) {
          ...
          Stream.prototype.initWebRtcPeerSend = function (reconnect) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var config = {
                ...
                simulcast:
                  _this.session.openvidu.advancedConfiguration
                        ...
                        case "completed":
                          logger.log(
                            "[" +
                              ...
                              finalIceStateAfterReconnection
                          );
                          break;
                        default:
                          logger.error(
          ...
          Stream.prototype.isWebsocketConnected = function (
            ...
            return new Promise(function (resolve, reject) {
              ...
              if (wsReadyState === 1) {
                ...
                console.warn(
                  "[" + event + "] Websocket readyState is " + wsReadyState
                );
                resolve(false);
              }
            });
      ...
      function (require, module, exports) {
        ...
        var StreamManager = (function (_super) {
            ...
            if (!!targetElement) {
              ...
              if (!!targEl) {
                ...
                if (
                  ...
                  _this.firstVideoElement.video.setAttribute(
                    "playsinline",
                    "true"
                  );
                }
          ...
          StreamManager.prototype.addVideoElement = function (video) {
            ...
            this.stream.session.streamManagers.forEach(function (
              streamManager
            ) {
    ...
    50: [
      ...
      { "../Logger/OpenViduLogger": 66, "./Event": 44 },
    ],
    51: [
      function (require, module, exports) {
        "use strict";
    ...
    66: [
              ...
              if (
                ...
                var beforeSendCallback = function (xhr) {
                  ...
                  xhr.setRequestHeader(
                    "Authorization",
                    "Basic " +
                      btoa(finalUserId_1 + "%/%" + sessionId_1 + ":" + token)
                  );
                ...
                this.instance.currentAppender = jsnlog_1.JL.createAjaxAppender(
                  "appender-" + finalUserId_1 + "-" + sessionId_1
                );
                  ...
                  var getCircularReplacer = function () {
                    ...
                    return function (key, value) {
                      if (typeof value === "object" && value != null) {
                        if (
                          seen.has(value) ||
                          (HTMLElement && value instanceof HTMLElement)
                        ) {
                          return;
                        }
                        seen.add(value);
                ...
                jsnlog_1
                  .JL()
                  .setOptions({ appenders: [this.instance.currentAppender] });
      ...
      { "./ConsoleLogger": 65, "./OpenViduLoggerConfiguration": 67, jsnlog: 7 },
    ],
    67: [
      function (require, module, exports) {
        "use strict";
    ...
    71: [
      function (require, module, exports) {
        ...
        var simulcastVideoEncodings = [
          { rid: "r0", scaleResolutionDownBy: 4 },
          { rid: "r1", scaleResolutionDownBy: 2 },
          { rid: "r2", scaleResolutionDownBy: 1 },
        ];
                ...
                return __generator(this, function (_d) {
                  switch (_d.label) {
                        ...
                        reject(
                          new Error(
                            this.configuration.mode +
                              " direction requested, but no stream was configured to be sent"
                          )
                        );
                        return [2];
                      }
                      (_i = 0),
                        (_a = this.configuration.mediaStream.getTracks());
                      _d.label = 1;
                    case 1:
                      ...
                      if (
                        !(
                          this.configuration.simulcast && track.kind === "video"
                        )
                      )
                        return [3, 3];
                    ...
                    case 7:
                      ...
                      logger.debug(
                        "RTCPeerConnection.createOffer() options:",
    ...
    72: [
      ...
      { "../Logger/OpenViduLogger": 66, "../Utils/Platform": 70 },
    ],
  },
  {},
  [28]
